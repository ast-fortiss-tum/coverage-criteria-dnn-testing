...
class Coverage():
    ...
    def update_coverage(self, outputs):
        if outputs is None or len(outputs) == 0:
            print("Warning: No data to update coverage.")
            return []
        '''
        ...
        '''
        #print("Updating coverage with input data of shape:", outputs[0].shape)
        #print("Unique values in outputs:", [np.unique(output) for output in outputs])
